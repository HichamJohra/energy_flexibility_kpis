...
class DeviationDecreaseFromTheFlatDemandProfile(KPI):
    """This index evaluate the ability of lighting power flexibility in the modification of a 
    building demand profile focusing on the variance of the demand profile (y values)."""
...
class FlexibilityMap(KPI):
    """Flexibility map (upward and downward load profile for the next 24h). Calculated by MPC 
    with black box model of the building and energy price forecast."""
